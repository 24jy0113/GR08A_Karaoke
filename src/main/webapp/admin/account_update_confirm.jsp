...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/01_07.css">
    ...
    <main>
        <div>
            ...
            <div class="action-buttons">
                <button type="button" class="btn-back" onclick="location.href='account_update.jsp'">修正する</button>
                <button type="submit" class="btn-next" onclick="location.href='account_update_confirmed.jsp'">変更を完了する</button>
            </div>
        </div>
    </main>
