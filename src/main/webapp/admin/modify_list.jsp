...
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/08_02.css">
			...
			<div class="msg">
				...
				<table>
					...
					<c:forEach var="item" items="${searchResult}">
						<tr>
							...
							<td><button type="submit" name="edit" value="${item.id }" formaction="<%=request.getContextPath()%>/ItemEditServlet">変更</button></td>
							<td><button type="submit" name="delete" value="${item.id }" formaction="modify_delete.jsp">削除</button></td>
						</tr>
						</c:forEach>
					</form>
				</table>
				...
				<div class="action-buttons">
					<button type="button" class="btn-back"
						onclick="history.back()">商品検索画面へ戻る</button>
