...
<head>
    <meta charset="UTF-8">
    <title>オプション選択</title>
    <link rel="stylesheet" type="text/css" href="./css/06_04.css">
...
<body>
        ...
        <div class="header_inner">
            ...
            <nav class="gnav">
                <ul class="gnav_list">
                    ...
                    <li><a href="06_01メニュー番号入力.html">メニューを番号で探す</a></li>
                    <li><a href="06_02商品一覧画面.html">フード・ドリンク</a></li>
    ...
    <main>
        ...
        <div class="action-buttons">
            <button type="button" class="btn-back" onclick="location.href='item_detail.jsp'">戻る</button>
