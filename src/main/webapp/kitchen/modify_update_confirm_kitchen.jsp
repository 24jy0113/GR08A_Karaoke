...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/08_04.css">
        ...
        <div class="bodymsg">
            <div class="msg">
                ...
                <div class="action-buttons">
                    ...
                    <button type="button" class="btn-back" onclick="location.href='history.back()">修正する</button>
