...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/08_03.css">
...
<body>
    ...
    <main>
        ...
        <div class="container">
            <!-- 左側：画像領域 -->
            <div>
                <div class="left-box"><img src="./img/salad.png" alt=""></div>
            </div>
            <!-- 右側：検索欄＋テンキー -->
            <div class="right-box">
                <div class="input-row">
        ...
        <div class="action-buttons">
            <button type="button" class="btn-back" onclick="location.href='modify_list_kitchen.jsp'">該当商品一覧へ戻る</button>
